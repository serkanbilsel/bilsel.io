...
namespace serkanbilsel.Migrations
{
    ...
    [Migration("20231103123018_sbioupdatecomment")]
    partial class sbioupdatecomment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("serkanbilsel.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 11, 3, 15, 30, 18, 128, DateTimeKind.Local).AddTicks(7501),
                            Email = "info@sb.io",
                            IsActive = true,
                            IsAdmin = true,
                            Name = "Admin",
                            Password = "12qk12qk",
                            UserGuid = new Guid("f3c393bd-8b1e-4602-89d8-9b52428fa508"),
                            UserName = "Serkan"
                        });
                });
