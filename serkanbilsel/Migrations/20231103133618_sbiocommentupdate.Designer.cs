...
namespace serkanbilsel.Migrations
{
    ...
    [Migration("20231103133618_sbiocommentupdate")]
    partial class sbiocommentupdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("serkanbilsel.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 11, 3, 16, 36, 17, 658, DateTimeKind.Local).AddTicks(1866),
                            Email = "info@sb.io",
                            IsActive = true,
                            IsAdmin = true,
                            Name = "Admin",
                            Password = "12qk12qk",
                            UserGuid = new Guid("d0560bdf-1ef8-49f0-9a59-18fe8d17ad6c"),
                            UserName = "Serkan"
                        });
                });
